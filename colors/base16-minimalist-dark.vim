...
" Minimalist Dark scheme by Medulli (https://github.com/medulli)
...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-minimalist-dark.sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-minimalist-dark"
