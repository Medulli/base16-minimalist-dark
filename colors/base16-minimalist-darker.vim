...
" Minimalist Darker scheme by Medulli (https://github.com/medulli)
...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-minimalist-darker.sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-minimalist-darker"
...
" Python highlighting
call <sid>hi("pythonOperator",  s:gui05, "", s:cterm0E, "", "", "")
call <sid>hi("pythonRepeat",    s:gui0A, "", s:cterm0E, "", "", "")
call <sid>hi("pythonInclude",   s:gui0D, "", s:cterm0E, "", "", "")
call <sid>hi("pythonStatement", s:gui08, "", s:cterm0E, "", "", "")
